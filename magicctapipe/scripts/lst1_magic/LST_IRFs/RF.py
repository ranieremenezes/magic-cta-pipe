...
def RandomForest(target_dir):
    ...
    f.write(f'conda run -n magic-lst python lst1_magic_train_rfs.py --input-dir-gamma {MC_DL1_dir}/gammadiffuse/Merged_Stereo --input-dir-proton {MC_DL1_dir}/protons/Merged_Stereo --output-dir {MC_DL1_dir}/RFs --config-file {target_dir}/config_RF.yaml --train-energy --train-disp --train-classifier --use-unsigned >$LOG 2>&1\n')
